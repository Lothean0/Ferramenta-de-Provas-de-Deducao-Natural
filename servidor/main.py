...
class Rule:
    def __init__(self, name, other_names, description, apply):
        self.name = name
...
def apply_Implication_Elimination(logical_expr: str, knowledge_base: List[str]) -> Optional[str]:
...
def apply_rule(logical_expr: str, rule_name: str, knowledge_base: List[str]) -> Optional[str]:
